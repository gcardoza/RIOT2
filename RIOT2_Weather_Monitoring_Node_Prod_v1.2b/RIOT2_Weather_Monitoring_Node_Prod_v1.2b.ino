...
//  Revision: December 12th, 2016 - Fixed condition where BME280 is not present (For an Alarm only config)
//
...
void loop()
{
  ...
  if (Current_Time >= Last_Publish_Time + Update_Interval)
  {
    ...
    if(BME280_Present) read_BME280();   // Temerature, Humidity & Pressure
